 ...
 * @author Yash Agarwal
 */
public class PVIEWCHILD extends javax.swing.JFrame {
...
public void close()
{
    ...
    private void Update_table(){
        ...
        String sql = "select childname as 'NAME', doctorname as 'DOCTORNAME', contactno as 'DOCTOR MOBILE NO', dateofbirth as 'BIRTH DATE',Gender ,height,weight from child where MobileNo =\'"+no+"\';";
...
close();         // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PVIEWCHILD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PVIEWCHILD().setVisible(true);
            }
        });
    }
